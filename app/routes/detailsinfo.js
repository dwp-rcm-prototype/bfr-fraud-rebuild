...
var functions = require('../views/detailsinfo/functions/functions.js');
var validate = require('../views/detailsinfo/functions/validations.js');
var get_routes = require('../views/detailsinfo/functions/dynamic_routes.js');
var session = require('../views/detailsinfo/functions/session.js');

// Start Page
  router.get('/start-page', function(req, res) {
    res.render('detailsinfo/start-page');
  });
// end Start Page
...
// Details
  router.get('/details', function(req, res) {
    ...
    res.render('detailsinfo/details', {options: options, session:session});
  });
  ...
  router.post('/details', function(req, res) {
    ...
    if ( validation.status === true ) {
      ...
      res.render('detailsinfo/details', {options: options, errors: validation.errors});
    }
  });
// end Details
...
// Details More
  router.get('/details-more', function(req, res) {
    ...
    res.render('detailsinfo/details-more', {details: details, session: session});
  });
  ...
  router.post('/details-more', function(req, res) {
    ...
    if ( validation.status === true ) {
      ...
      session.update(req, res);
      var details = req.cookies.details;
      res.render('detailsinfo/details-more', {details: details, session: req.body, errors: validation.errors, validate: validation});
    }
  });
// end Details More
...
// Fraud Type
  router.get('/fraud-type', function(req, res) {
    ...
    res.render('detailsinfo/fraud-type', {options: options, session: session});
  });
  ...
  router.post('/fraud-type', function(req, res) {
    ...
    if ( validation.status === true ) {
      ...
      res.render('detailsinfo/fraud-type', {options: options, session: req.body, errors: validation.errors});
    }
  });
// end Fraud Type
...
// Employment Details
  router.get('/employment-details', function(req, res) {
    ...
    res.render('detailsinfo/employment-details', {session: session});
  });
  ...
  router.post('/employment-details', function(req, res) {
    ...
    if ( validation.status === true ) {
      ...
      res.render('detailsinfo/employment-details', {session: req.body, errors: validation.errors});
    }
  });
...
// Partner Details
  router.get('/partner-details', function(req, res) {
    ...
    res.render('detailsinfo/partner-details', {session: session});
  });
  ...
  router.post('/partner-details', function(req, res) {
    ...
    if ( validation.status === true ) {
      ...
      res.render('detailsinfo/partner-details', {session: req.body, errors: validation.errors, validate: validation});
    }
  });
// end Partner Details
...
router.get('/partner-employment', function(req, res) {
  ...
  res.render('detailsinfo/partner-employment', {session: session});
});
...
router.post('/partner-employment', function(req, res) {
  ...
  if ( validation.status === true ) {
    ...
    res.render('detailsinfo/partner-employment', {session: req.body, errors: validation.errors});
  }
});
...
// Disability Benefit
  router.get('/disability', function(req, res) {
    ...
    res.render('detailsinfo/disability', {session: session});
  });
  ...
  router.post('/disability', function(req, res) {
    ...
    if ( validation.status === true ) {
      ...
      res.render('detailsinfo/disability', {session: req.body, errors: validation.errors, validate: validation});
    }
  });
...
// Carers Benefit
  router.get('/carers', function(req, res) {
    ...
    res.render('detailsinfo/carers', {session: session});
  });
  ...
  router.post('/carers', function(req, res) {
    ...
    if ( validation.status === true ) {
      ...
      res.render('detailsinfo/carers', {session: req.body, errors: validation.errors, validate: validation});
    }
  });
// end Carers Benefit
...
// Carers More
  router.get('/carers-more', function(req, res) {
    ...
    res.render('detailsinfo/carers-more', {session: session});
  });
...
// Abroad
  router.get('/abroad', function(req, res) {
    ...
    res.render('detailsinfo/abroad', {session: session});
  });
  ...
  router.post('/abroad', function(req, res) {
    ...
    if ( validation.status === true ) {
      ...
      res.render('detailsinfo/abroad', {session: req.body, errors: validation.errors});
    }
  });
// end Abroad
...
// Identity
  router.get('/identity', function(req, res) {
    ...
    res.render('detailsinfo/identity', {session: session});
  });
  ...
  router.post('/identity', function(req, res) {
    ...
    if ( validation.status === true ) {
      ...
      res.render('detailsinfo/identity', {session: req.body, errors: validation.errors, validate: validation});
    }
  });
// end Identity
...
// Income
  router.get('/income', function(req, res) {
    ...
    res.render('detailsinfo/income', {session: session});
  });
  ...
  router.post('/income', function(req, res) {
    ...
    if ( validation.status === true ) {
      ...
      res.render('detailsinfo/income', {session: req.body, errors: validation.errors, validate: validation});
    }
  });
// end Income
...
// Income More
  router.get('/income-more', function(req, res) {
    ...
    res.render('detailsinfo/income-more', {session: session});
  });
  ...
  router.post('/income-more', function(req, res) {
    ...
    if ( validation.status === true ) {
      ...
      res.render('detailsinfo/income-more', {session: req.body, errors: validation.errors, validate: validation});
    }
  });
// end Income More
...
// Additional Information
  router.get('/additional-information', function(req, res) {
    res.render('detailsinfo/additional-information', {session: session});
  });
...
// Additional Information
  router.get('/letusknow-letusknow', function(req, res) {
    res.render('detailsinfo/letusknow-letusknow', {session: session});
  });
...
// Other
  router.get('/other', function(req, res) {
    ...
    res.render('detailsinfo/other', {session: session});
  });
  ...
  router.post('/other', function(req, res) {
    ...
    if ( validation.status === true ) {
      ...
      res.render('detailsinfo/other', {session: req.body, errors: validation.errors, validate: validation});
    }
  });
// end Other
...
// Review
  router.get('/review', function(req, res) {
    ...
    res.render('detailsinfo/review', {review: review, additional: additional});
  });
...
// Review
  router.get('/complete', function(req, res) {
    res.render('detailsinfo/complete');
  });
// end Review
...
// Exit Page
  router.get('/exit', function(req, res) {
    ...
    if (  details.name && details.address && details.age ||
      ...
      res.render('detailsinfo/exit', {render: render});
    }
  });
  ...
  router.post('/exit', function(req, res) {
    ...
    if ( valid ) {
      ...
      res.render('detailsinfo/exit', {exit_warning: {'status': true, needed: needed}});
    }
  });
// end Exit Page
...
// Feedback
  router.get('/feedback', function(req, res) {
    res.render('detailsinfo/feedback');
  });

  router.post('/feedback', function(req, res) {
    res.render('detailsinfo/feedback-complete');
  });
// end Feedback
